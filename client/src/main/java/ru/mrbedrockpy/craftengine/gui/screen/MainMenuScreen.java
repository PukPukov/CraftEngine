...
public class MainMenuScreen {
    public static Screen create() {
        return UI.create().button("Play", Window.getWidth() / 2 - 50, Window.getHeight() / 2 - 50, 100, 100, button -> {
            CraftEngineClient.INSTANCE.setPlayer(new ClientPlayerEntity(new Vector3f(0, 0, 2), null));
            ClientWorld world = new ClientWorld(800, CraftEngineClient.INSTANCE.getPlayer(), CraftEngineClient.INSTANCE.getTickSystem());
