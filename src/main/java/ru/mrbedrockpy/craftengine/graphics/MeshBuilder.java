...
public class MeshBuilder {
    ...
    public void addFace(int x, int y, int z, Block.Direction dir, Block block, World world) {
        ...
        // Apply atlas transformation to UVs
        Vector2i tileUV = atlas.getUV(Registries.BLOCKS.getName(block));
