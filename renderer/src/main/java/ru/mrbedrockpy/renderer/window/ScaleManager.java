...
public final class ScaleManager {
    ...
    public void setGuiScale(int guiScale) {
        this.uiScale = Math.max(1, guiScale);
    }

    public int getGuiScale() { return uiScale; }

    public int logicalWidth()  { return toLogicalX(fbWidth); }
    public int logicalHeight() { return toLogicalY(fbHeight); }

    public int toPhysicalX(int logicalX) { return logicalX * uiScale; }
    public int toPhysicalY(int logicalY) { return logicalY * uiScale; }
