        ...
        while (distance <= maxDistance) {
            if (sideDistX < sideDistY) {
                if (sideDistX < sideDistZ) {
                    ...
                    lastFace = stepX > 0 ? IBlock.Direction.WEST : IBlock.Direction.EAST;
                } else {
                    blockPos.z += stepZ;
                    distance = sideDistZ;
                    sideDistZ += deltaDistZ;
                    lastFace = stepZ > 0 ? IBlock.Direction.NORTH : IBlock.Direction.SOUTH;
                }
            } else {
                if (sideDistY < sideDistZ) {
                    ...
                    lastFace = stepY > 0 ? IBlock.Direction.DOWN : IBlock.Direction.UP;
                } else {
                    blockPos.z += stepZ;
                    distance = sideDistZ;
                    sideDistZ += deltaDistZ;
